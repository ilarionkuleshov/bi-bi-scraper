...
const spiders = [
  {
    name: `${PROJECT_PREFIX}_product_detail_spider`,
    script: SCRAPY_SCRIPT,
    args: "crawl product_detail",
...
const producers = [
  {
    name: `${PROJECT_PREFIX}_product_detail_producer`,
    script: SCRAPY_SCRIPT,
    args: "product_detail_producer -m worker",
    interpreter: PYTHON_INTERPRETER,
    instances: 1,
    autorestart: true,
    cron_restart: "0 * * * *",
...
const consumers = [
  {
    name: `${PROJECT_PREFIX}_product_detail_replies_consumer`,
    script: SCRAPY_SCRIPT,
    args: "product_detail_replies_consumer -m worker",
    interpreter: PYTHON_INTERPRETER,
    instances: 1,
    autorestart: true,
    cron_restart: "0 * * * *",
  ...
  {
    name: `${PROJECT_PREFIX}_product_detail_results_consumer`,
    script: SCRAPY_SCRIPT,
    args: "product_detail_results_consumer -m worker",
    interpreter: PYTHON_INTERPRETER,
    instances: 1,
    autorestart: true,
    cron_restart: "0 * * * *",
